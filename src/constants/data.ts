import type { Service, Project, BeforeAfter, Package, Testimonial, BlogPost } from '../types';

export const SERVICES: Service[] = [
  { id: '1', title: 'Bahçe Tasarımı', description: 'Hayalinizdeki bahçeyi profesyonel tasarım ekibimizle hayata geçiriyoruz.', icon: 'leaf' },
  { id: '2', title: 'Peyzaj Projelendirme', description: '3D modelleme ile projenizi tamamlanmadan önce görün.', icon: 'map' },
  { id: '3', title: 'Sulama Sistemleri', description: 'Akıllı ve otomatik sulama sistemleri ile tasarruf edin.', icon: 'water' },
  { id: '4', title: 'Rulo Çim Uygulaması', description: 'Anında yeşil ve bakımlı bir çim alan elde edin.', icon: 'grass' },
  { id: '5', title: 'Bitkilendirme', description: 'İklime uygun bitki seçimi ve profesyonel dikim hizmeti.', icon: 'flower' },
  { id: '6', title: 'Bahçe Bakımı', description: 'Düzenli bakım ile bahçeniz her mevsim mükemmel kalsın.', icon: 'cut' },
  { id: '7', title: 'Aydınlatma Sistemleri', description: 'Bahçenizi gece de büyüleyici kılan aydınlatma çözümleri.', icon: 'bulb' },
  { id: '8', title: 'Otomatik Sulama', description: 'Zamanlayıcılı sulama sistemleri ile suyunuzu verimli kullanın.', icon: 'timer' },
];
...
export const NAV_LINKS = [
  ...
  { label: 'Hakkımızda', href: '#neden-peyzajet' },
